...
public class CounterInterstitial {
    ...
    private static CounterInterstitial TInstance;

    static int gclick = 1;

    public static CounterInterstitial getInstance() {
        if (TInstance == null) {
            TInstance = new CounterInterstitial();
        }
        return TInstance;
    }
